...
//import 'package:flutter_supabase/siswa_home.dart';
...
Future<void> main() async {
  ...
  await Supabase.initialize(
    url: 'https://ahrigizztxwpvdpcnkdc.supabase.co',
    anonKey:
        'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImFocmlnaXp6dHh3cHZkcGNua2RjIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MjgyMjk4MjQsImV4cCI6MjA0MzgwNTgyNH0.tqWaIm01b2Ium2E25grm01iZPQgheQxv4Ie3yUIQ5mY',
  );
  runApp(const MyApp());
  //runApp(const SiswaHome());
}
